...
#define SC_KERNEL_STACK_TOP_OFFSET  X86_MISC_STATE_SYSCALL_KERNEL_STACK_TOP_OFFSET
...
extern "C" {
        [[gnu::used]] uintptr_t syscall_x86_table[SYSCALL_COUNT];
}
